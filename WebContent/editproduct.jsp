...
<html lang="en"><head>
  ...
  ArrayList<TransactionLineItem> item_list = Model.getTransactionLineItemsByTransId(transaction.getId());
  %>
       <nav class="navbar navbar-custom">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a class="navbar-link navbar-brand" href="index.jsp">Talaria</a>
                </div>
                <div>
        ...
        <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
              <hr>
            <form id = "editprod" action = "editproduct" method = "post" class="form-edit">
